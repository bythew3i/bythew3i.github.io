...
date:           2018-01-03
author:         bythew3i
assets-path:       /assets/2018-01-03-projects-gallery-20162017/
header-img:     assets/2018-01-03-projects-gallery-20162017/xiao.jpg
header-mask:    0.5
catalog:        true
tags:
    - Java
...
### Pokémon Catch
![mfc1.png]({{page.assets-path}}mfc1.png)
...
### Animation Maker
![mfc2.png]({{page.assets-path}}mfc2.png)
...
`IDE`| Visual Studio (MFC)
`Required Environment`| Windows
`URL`| https://github.com/bythew3i/TransformDlgApp
...
### Mad Hatter
<img alt="ad1.jpeg" src="{{page.assets-path}}ad1.jpeg" width="50%">
...
### Connect 4 online
<img alt="ad2.jpeg" src="{{page.assets-path}}ad2.jpeg" width="50%">
...
### MSU Parking Tips
<img alt="ad3.jpeg" src="{{page.assets-path}}ad3.jpeg" width="50%">
